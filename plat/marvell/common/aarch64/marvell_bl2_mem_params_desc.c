...
# else
	    .ep_info.pc = MARVELL_BL33_BASE + MARVELL_KERNEL_TEXT_OFFSET, /* where the XBASE located image will be decompressed */


	    SET_STATIC_PARAM_HEAD(image_info, PARAM_EP,
		    VERSION_2, image_info_t, 0),
	    .image_info.image_base =  MARVELL_BL33_GZBASE, /* compressed image */
	    .image_info.image_max_size = MARVELL_BL33_GZSIZE,
